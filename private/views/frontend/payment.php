<?php if (!isset($_SESSION['code'])) {
	header('location:http://localhost/web/frontend/checkout/');
} ?>
<!DOCTYPE html>
<html lang="zxx">
...
<body>
										...
										<div class="checkbox">
											<div class="check_box_one cashon_delivery">
												<label class="anim">
													...
													<form action="" method="post">
														<input type="email" placeholder="Enter your email to get bill" name="email" required>
				...
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						<div class="item">
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g1.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g2.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g3.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g4.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
							</div>
						</div>
						<div class="item active">
							<div class="row">
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g5.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g6.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
								<div class="col-md-3 col-sm-3 col-xs-3 slidering">
									<div class="thumbnail"><img src="../../public/images/g2.jpg" alt="Image" style="max-width:100%;"></div>
								</div>
				...
				<div class="col-md-9 footer-right">
					<div class="sign-grds">
						...
						<div class="col-md-3 sign-gd flickr-post">
							...
							<ul>
								<li><a href="single.html"><img src="../../public/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t4.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t1.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t3.jpg" alt=" " class="img-responsive" /></a></li>
								<li><a href="single.html"><img src="../../public/images/t2.jpg" alt=" " class="img-responsive" /></a></li>
	...
	<!-- credit-card -->
	<script type="text/javascript" src="../../public/js/creditly.js"></script>
