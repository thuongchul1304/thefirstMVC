...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <form action="" method="POST" enctype="multipart/form-data" id="addtin">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        <label>Ngày</label>
                        <input type="date" name="producedDate" class="form-control" required >
                    </div>
              <div class="form-group col-sm-6">
                <label>Miêu tả</label>
                <textarea name="desciption" id="editor1">
        ...
        <div class="form-group col-sm-12">
            <input name="create" type="submit" value="Sửa" class="btn btn-success">
            <input type="reset" type="submit" class="btn btn-danger" value="Nhập lại">
            <a href="list" class="btn btn-primary">Danh sách</a>
        </div>
    </div>
</form>
</div>
