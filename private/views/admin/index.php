...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
           ...
           <h3>List</h3><a class="btn btn-success" href="add">Thêm sản phẩm</a>
                ...
                <tbody>
                    ...
                    foreach ($result as $value) {
                        ...
                        <tr>
                            <th><?=$value['Name']?></th>
                            <th>$<?=$value['Price']?></th>
                            <th>$<?=$value['PriceNew']?></th>
                            <th><img src="http://localhost/web/public/images/shoes/<?=$value['Image']?>" width="20%"></th>
                            <th><?=$value['Date']?></th>
                            <th><?=$value['Quantity']?></th>
                            <td>
                                <a href="edit/<?=$value['Id']?>" class="btn btn-info" >Sửa</a></td>
                                <td>
                                    <a href="del/<?=$value['Id']?>"class="btn btn-danger" onclick="return ConfirmDelete('Bạn có chắc xóa danh mục này ?')"; >Xóa</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
